...
/// 状态图节点默认着色回调: 按节点 id 状态后缀使用主题颜色
///   *_in_progress -> theme.diagram_running
///   *_completed   -> theme.diagram_done
///   *_failed      -> theme.diagram_failed
///   *_pending     -> theme.diagram_pending
/// 其他 id 返回 Color::Default (不着色, 继承外层装饰)
std::function<ftxui::Color(std::string_view)> diagramNodeColor(Theme const& theme);
